...
import com.oop.inventory.Inventory;
...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
		...
		if (!matchingGuitars.isEmpty()) {
			System.out.println("Kaush, you might like these guitars:");
			...
			System.out.println("Sorry, Kaush, we have nothing for you.");
		}
	}
